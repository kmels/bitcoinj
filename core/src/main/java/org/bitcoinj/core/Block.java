...
public class Block extends Message {
    ...
    public static final int BCC_MAX_BLOCK_SIGOPS = BCC_MAX_BLOCK_SIZE / 50;
    ...
    private void checkSigOps() throws VerificationException {
        ...
        if (sigOps > getParams().getMaxBlockSigops())
    ...
    public void verifyTransactions(final int height, final EnumSet<VerifyFlag> flags) throws VerificationException {
        ...
        if (this.getOptimalEncodingMessageSize() > getParams().getMaxBlockSize())
