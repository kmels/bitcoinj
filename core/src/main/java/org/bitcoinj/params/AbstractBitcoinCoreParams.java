 ...
 */
public abstract class AbstractBitcoinCoreParams extends NetworkParameters {
    /**
     * Scheme part for Bitcoin URIs.
     */
    public static final String BITCOIN_SCHEME = "bitcoin";

    private static final Logger log = LoggerFactory.getLogger(AbstractBitcoinCoreParams.class);

    public AbstractBitcoinCoreParams() {
        super();
    }
    ...
    public void checkDifficultyTransitions(final StoredBlock storedPrev, final Block nextBlock,
        ...
        new Exception("This method is for Bitcoin CASH and should not be called. For core use the other checkDifficultyTransitions method.");
    }
