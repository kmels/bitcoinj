...
public enum ScriptError {
    ...
    SCRIPT_ERR_UNEXPECTED_PAYTO_PUBKEY_FORM("SCRIPT_ERR_UNEXPECTED_PAYTO_PUBKEY_FORM"),
    ...
    SCRIPT_ERR_DIVISION_BY_ZERO_ERROR("SCRIPT_ERR_DIVISION_BY_ZERO_ERROR"),
    SCRIPT_ERR_MODULO_BY_ZERO_ERROR("SCRIPT_ERR_MODULO_BY_ZERO_ERROR"),
