...
public class Wallet extends BaseTaggableObject
            ...
            for (TransactionOutput o : tx.getOutputs()) {
                try {
                    ...
                    if (ScriptPattern.isPayToPubKey(script)) {
                        byte[] pubkey = ScriptPattern.extractKeyFromPayToPubKey(script, tx.getParams().getUseForkId());
    ...
    public boolean canSignFor(Script script) {
        if (ScriptPattern.isPayToPubKey(script)) {
            byte[] pubkey = ScriptPattern.extractKeyFromPayToPubKey(script, getParams().getUseForkId());
